...
import { Text, TouchableOpacity, View, Modal, Picker, Dimensions, StyleSheet } from 'react-native';
...
export default class CountryPicker extends Component {
  ...
  render() {
    ...
    const { width, ...pStyles} = StyleSheet.flatten(this.props.pickerStyle);
    if (!this.state || this.state.modalVisible !== true) return <View />
    return (
      <Modal
        animationType="slide"
        transparent
      ...
      >
        <View style={styles.basicContainer}>
          <View
            style={[
              styles.modalContainer, pStyles,
              { backgroundColor: this.props.pickerBackgroundColor || 'white',
                width: width || SCREEN_WIDTH},
            ]}
          >
            <View style={[styles.buttonView, pStyles, {width: width || SCREEN_WIDTH}]}>
            ...
            <View style={styles.mainBox}>
              <Picker
                ...
                style={[styles.bottomPicker, pStyles, {width: width || SCREEN_WIDTH}]}
